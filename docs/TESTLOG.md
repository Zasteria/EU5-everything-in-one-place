...
**2026-09-20, `gui.clearwidgets` — кандидат выбыл, и это его наблюдение.** Он
пару раз заходил в debug mode и увидел, что команда **сама печатается в консоль
время от времени**, и игре это не помогает. Сходится с файлами: в
`ui_library.gui:18261` это **кнопка закрытия окна UI Library**, то есть чистка
виджетов самого отладочного окна, а не метла по дереву. Ждать от неё было нечего
с самого начала. Прогона на неё больше не просить.
