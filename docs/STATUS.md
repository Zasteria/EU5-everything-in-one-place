...
| [`cm_perf`](../mods/cm_perf/CLAUDE.md) | **новый 09-18, в игре не был.** Копия Construction Manager, в которой дерево по всем типам зданий в его скрытом окне получило те же ворота, что стоят на его драйвере. Ставится **вместо** CM | всё; что должен показать прогон — в брифе |
