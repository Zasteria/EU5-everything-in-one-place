...
| [`where_to_produce`](../mods/where_to_produce/CLAUDE.md) | **Единственная версия, и работа идёт в ней.** Его список после партии записан — [`investigations/wtp_backlog.md`](investigations/wtp_backlog.md), девять пунктов и открыт. Из девяти пунктов открыты два: 9 (ручное заполнение) и ванильная отмашка автостроя. Карта «Лучшее городское право» перенесена из CM dev целиком — [`investigations/wtp_town_right_map.md`](investigations/wtp_town_right_map.md), там же разбор его расчёта и три отличия от нашего. Попытка второй версии закрыта в день начала ([`archive/wtp2_failed.md`](archive/wtp2_failed.md)) | **всё, что построено 2026-09-12, прогона не видело**; **четыре починки 09-14 — «Пригодность» 0 %, «−» на здании обеих сторон, полнота правого списка и процент в нём — тоже не видели**; и **его слово 09-12: 90% из того, что документы звали непрогнанным, уже прогонялось или неактуально** — сверять с ним, не с документами |
