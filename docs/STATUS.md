...
| [`war_sliders`](../mods/war_sliders/CLAUDE.md) | **0.3, привод найден и проверен 09-17**: наш ползунок двигает ползунок игры, и чеканку, и все три содержания. Собран рабочий мод — страница настроек CMF, срабатывание по переключению «война → мир» | сам мод целиком: настройки, такт, приводы |
