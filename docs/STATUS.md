...
| [`cm_perf`](../mods/cm_perf/CLAUDE.md) | **работает, прогон 09-18.** Копия Construction Manager с воротами на дереве типов зданий в скрытом окне: потолок скорости снят. Ставится **вместо** CM | функционал самого CM — что смотреть, в брифе |
