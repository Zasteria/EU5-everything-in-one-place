...
| [`marker_throttle`](../mods/marker_throttle/CLAUDE.md) | **09-20: первая сборка сломала выбор отрядов щелчком.** 0.2.0 сужен до трёх типов без кнопок и раскладки. Тормоз `max_update_rate`, которого на отрядах нет ни у кого | 0.2.0 |
