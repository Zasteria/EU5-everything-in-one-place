...
| [`nmt_ru`](../mods/nmt_ru/CLAUDE.md) | **новый 09-22, в игре не был: лаунчер его не показал, не хватало `relationships` — дописан.** Русский для National Mission Trees: Валахия, Византия, Феодоро, Грузия, Ахен, Брабант, Флоренция, Монферрат — 1 365 ключей из 8 798. База без русского и без отката, дерево пишется целиком | всё |
