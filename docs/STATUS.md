...
| [`war_sliders`](../mods/war_sliders/CLAUDE.md) | **новый 09-16, один прогон.** Ползунки «Чеканка» и «Содержание» после войны. Скриптом они не двигаются вовсе; вызов интерфейса из нашего окна до игры доходит (галочка авто-чеканки переключилась), панель читается снаружи — **не проверено, доходит ли запись**: зонд 0.2 спрашивает это двумя опытами | сам привод к ползунку |
