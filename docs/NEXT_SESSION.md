...
режим «провинцией» работают. **Компенсация отстающим не работала три захода
подряд**, и третий кончился тем, что сессия вписала лестницу в **режим
специализации** — прогон шёл в нём, — а он снял это в тот же час: «лучшее
ставить, и в ней вполне может быть 0 каких-то прав». **Откачено.** Осталось:
отставание уклоном в обычной раздаче и галочка «Грамоты — поровну» (снята).
