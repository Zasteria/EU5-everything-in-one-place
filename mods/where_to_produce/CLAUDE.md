...
«авторасширение» ставит ванильную галочку зданиям плана — **и стоящим, и
строящимся**. Дверь к стоящему — `Scope.GetBuilding`, то есть скрипт, а не
интерфейс ([`RESEARCH.md`](../../docs/RESEARCH.md)); кнопка не горит, потому что
прочитать галочку скрипт не может. С CM всё как было. **Прогона не видело.**
